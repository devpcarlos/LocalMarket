...
public interface IProductService
    {
        ...
        Task<ProductDto> CreateAsync(Guid userId, Guid businessId, RequestProductDto dto);
        Task<ProductDto> UpdateAsync(Guid userId, Guid productId, RequestProductDto dto);
